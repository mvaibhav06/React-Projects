        ...
        <div>
            ...
            <div className="dropdown">
                <button className="dropbtn">
                    <a href="https://wazirx.com/invite/sp7pvbt6?utm_source=finstreet&utm_medium=affiliate&utm_campaign=regnow-btn" style={{textDecoration:"none"}}>BUY BTC</a>
                </button>
